	...
	<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
		<div class="bg-[#F3F3F1] p-12 rounded-lg border border-gray-200 flex flex-col items-center text-center hover:bg-[#EAEAE8] transition-colors">
			...
			<div class="flex items-center gap-2 mb-4 text-primary-600">
				...
				<span class="font-mono text-xs uppercase tracking-widest">SECURE IAM ROLES</span>
			</div>
			<p class="text-gray-600 text-sm max-w-sm">
				Connect via AWS IAM roles with no credentials stored. Granular permissions and full audit trail. <a href="/" class="underline decoration-gray-400 hover:text-gray-900">Learn more</a>
			</p>
		</div>
		...
		<div class="bg-[#F3F3F1] p-12 rounded-lg border border-gray-200 flex flex-col items-center text-center hover:bg-[#EAEAE8] transition-colors">
			...
			<div class="flex items-center gap-2 mb-4 text-accent-yellow">
				...
				<span class="font-mono text-xs uppercase tracking-widest">SOC 2 TYPE II</span>
			</div>
			<p class="text-gray-600 text-sm max-w-sm">
				Enterprise-grade security with SOC 2 Type II compliance. Data encrypted at rest and in transit.
			</p>
		</div>
	</div>
</section>
